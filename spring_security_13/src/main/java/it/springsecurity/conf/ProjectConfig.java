...
import it.springsecurity.repository.CustomCsrfTokenRepository;
...
public class ProjectConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		// Per tutti gli altri url se il ruolo dell'utente non è compreso tra quelli
		// elencati l'accesso è respinto e gestito dall'handler
		http.authorizeRequests().anyRequest().hasAnyAuthority("READER", "GUEST", "CREATOR").and().exceptionHandling()
